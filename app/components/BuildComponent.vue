<template>
  <div class="space-y-3">
    ...
    <TerminalSection
        title="build output"
        :lines="[
              '✓ Compiled expertise in developer experience',
              '✓ Generated comprehensive documentation skills',
              '✓ Built community engagement capabilities',
              '✓ Optimized for maximum developer happiness'
            ]"
    />
  </div>
</template>